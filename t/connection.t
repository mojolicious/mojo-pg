...
is $pg->username, '',                    'no username';
is $pg->password, '',                    'no password';
$options = {AutoCommit => 1, AutoInactiveDestroy => 1, PrintError => 0, PrintWarn => 0, RaiseError => 1};
is_deeply $pg->options, $options, 'right options';
...
is $pg->username, '',                   'no username';
is $pg->password, '',                   'no password';
$options = {AutoCommit => 1, AutoInactiveDestroy => 1, PrintError => 1, PrintWarn => 1, RaiseError => 1};
is_deeply $pg->options, $options, 'right options';
...
$pg = Mojo::Pg->new('postgresql://x1:y2@%2ftmp%2fpg.sock/test4?PrintError=1&RaiseError=0');
...
$options = {AutoCommit => 1, AutoInactiveDestroy => 1, PrintError => 1, PrintWarn => 0, RaiseError => 0};
is_deeply $pg->options, $options, 'right options';
...
$options = {AutoCommit => 1, AutoInactiveDestroy => 1, PrintError => 0, PrintWarn => 0, RaiseError => 0};
is_deeply $pg->options, $options, 'right options';
